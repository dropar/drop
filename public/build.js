...
var microtask = __webpack_require__(162)();
...
router.on({
  ...
  'assets/:id': function assetsId(params) {
    assetFetcher.fetchCurrentAsset(params.id).then(function () {
      // console.log(`currentAsset-----------------> ${JSON.stringify(localStorage.getItem('currentAsset'))}`)
...
__webpack_require__(143); // require('./components/test-component-2');
...
__webpack_require__(90); // require('./router.js');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              localStorage.setItem('currentAsset', JSON.stringify(asset)); // let curAss = localStorage.getItem('currentAsset');
              // console.log(`currentAsset-----------------> ${JSON.stringify(curAss)}`)
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(159));
